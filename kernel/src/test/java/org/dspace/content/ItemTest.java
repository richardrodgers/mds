...
public class ItemTest  extends AbstractDSpaceObjectTest
{
    ...
    public void testGetLastModified()
    {
        ...
        assertTrue("testGetLastModified 1", 
        		Days.daysBetween(new DateTime(it.getLastModified().getTime()), new DateTime()).getDays() < 1);
    }
    ...
    public void testWithdrawAuth() throws Exception
    {
        new NonStrictExpectations()
        {
            AuthorizeManager authManager;
            {
                AuthorizeManager.authorizeWithdrawItem((Context) any, (Item) any);
                    result = null;
            }
        };
    ...
    public void testReinstateAuth() throws Exception
    {
        new NonStrictExpectations()
        {
            AuthorizeManager authManager;
            {
                AuthorizeManager.authorizeWithdrawItem((Context) any, (Item) any);
                    result = null;
                AuthorizeManager.authorizeReinstateItem((Context) any, (Item) any);
                    result = null;
            }
        };
