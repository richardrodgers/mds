...
public class CollectionTest extends AbstractDSpaceObjectTest
{
    ...
    public void testCreateWorkflowGroupAuth() throws Exception
    {
        new NonStrictExpectations()
        {
            AuthorizeManager authManager;
            {
                AuthorizeManager.authorizeManageWorkflowsGroup((Context) any, (Collection) any);
                    result = null;
            }
        };
    ...
    public void testCreateSubmittersAuth() throws Exception
    {
        new NonStrictExpectations()
        {
            AuthorizeManager authManager;
            {
                AuthorizeManager.authorizeManageSubmittersGroup((Context) any, (Collection) any);
                    result = null;
            }
        };
    ...
    public void testCreateAdministratorsAuth() throws Exception
    {
        new NonStrictExpectations()
        {
            AuthorizeManager authManager;
            {
                AuthorizeManager.authorizeManageAdminGroup((Context) any, (Collection) any);
                    result = null;
            }
        };
    ...
    public void testRemoveAdministratorsAuth() throws Exception
    {
        new NonStrictExpectations()
        {
            AuthorizeManager authManager;
            {
                AuthorizeManager.authorizeRemoveAdminGroup((Context) any, (Collection) any);
                    result = null;
            }
        };
    ...
    */
    ...
    public void testDeleteAuth() throws Exception
    {
        new NonStrictExpectations()
        {
            AuthorizeManager authManager;
            {
                AuthorizeManager.authorizeManageTemplateItem((Context) any, (Collection) any);
                 result = null;
                AuthorizeManager.authorizeAction((Context) any, (Collection) any,
