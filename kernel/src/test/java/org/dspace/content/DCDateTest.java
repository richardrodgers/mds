...
{
    /** log4j category */
    private static Logger log = LoggerFactory.getLogger(DCDateTest.class);
    ...
    {
        assertTrue("testGetCurrent 0", 
        		Days.daysBetween(new DateTime(DCDate.getCurrent().toDate().getTime()), new DateTime()).getDays() < 1);
    }
