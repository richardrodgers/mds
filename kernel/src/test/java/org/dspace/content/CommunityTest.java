...
public class CommunityTest extends AbstractDSpaceObjectTest
{
    ...
    /** log4j category */
    private static final Logger log = LoggerFactory.getLogger(CommunityTest.class);
    ...
    public void testCreateAdministratorsAuth() throws Exception
    {
        ...
        {
            {
                AuthorizeManager.authorizeManageAdminGroup((Context) any, (Community) any);
                result = null;                
            }
        };
    ...
    public void testRemoveAdministratorsNoAuth() throws Exception
    {
        ...
        {
            {
                AuthorizeManager.authorizeRemoveAdminGroup((Context) any, (Community) any);
                    result = new AuthorizeException();
            }
        };
