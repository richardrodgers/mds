 ...
 * 
 * RLR - merged in app/util/AuthorizeUtil (A Bollini) methods.
 */
public class AuthorizeManager
{
     ...
     *             if a db error occur
     */
    public static void authorizeManageAdminGroup(Context context, Community community)
    		      throws AuthorizeException, SQLException
    {
            ...
            Community community) throws SQLException, AuthorizeException
    {
        ...
        {
            authorizeAction(context, parentCommunity, Constants.ADMIN);
        }
        else if (! isAdmin(context))
        {
            throw new AuthorizeException(
            ...
            Collection collection) throws AuthorizeException, SQLException
    {
        ...
        else if (!isAuthorized && ! isAdmin(context)) 
        {
            throw new AuthorizeException(
            ...
            throws SQLException, AuthorizeException
    {
        ...
        {
            authorized = authorizeActionBoolean(context, item
