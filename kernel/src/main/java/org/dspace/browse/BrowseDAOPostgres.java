...
{
    /** Log4j log */
    private static Logger log = LoggerFactory.getLogger(BrowseDAOPostgres.class);
    ...
    {
        return Arrays.copyOf(this.countValues, this.countValues.length);
    }
    ...
    {
        return Arrays.copyOf(selectValues, selectValues.length);
    }
    ...
    {
        this.countValues = Arrays.copyOf(fields, fields.length);
        this.rebuildQuery = true;
    }
    ...
    {
        this.selectValues = Arrays.copyOf(selectValues, selectValues.length);
        this.rebuildQuery = true;
    }
