...
/**
 * METS handing removed pending packager refactor
 * RLR
 */
...
public class SwordMETSContentIngester extends AbstractSwordContentIngester
{
            ...
            throws DSpaceSwordException, SwordError, SwordAuthException, SwordServerException
    {
        try
		{
            ...
            //List<Bundle> licenseBundles = item.getBundles(Constants.LICENSE_BUNDLE_NAME);
            //if (licenseBundles.size() == 0 || licenseBundles.get(0).getBitstreams().size == 0) {
            //	licenseBundles.get(0).addBitstream(collection.getLicense());
            //}
            ...
            */
			...
			DSpaceObject ingestedObject = null; //pi.replace(context, item, depositFile, params);
